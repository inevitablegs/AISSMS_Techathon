...
const handleQuestionsComplete = async () => {
    ...
    if (result.success) {
        ...
        setPacingData(prev => ({
            ...
            pacingHistory: [...prev.pacingHistory, {
        ...
        setAtoms(prev => prev.map(a => 
            a.id === currentAtom.id 
                ? { ...a, phase: 'complete', mastery_score: data.metrics.final_mastery }
                : a
        ));
        ...
        } else if (data.next_action.action === 'recommend_review' || 
    ...
    if (!session || !currentAtom) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <p className="text-gray-600 mb-4">No atoms available for this concept.</p>
                    <button
                        onClick={() => navigate('/dashboard')}
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">
                                Level: <span className="capitalize font-medium">{session.knowledge_level}</span>
                            </p>
                        </div>
                        
                        {/* Pacing Indicator */}
                        <div className={`px-4 py-2 rounded-lg ${getPacingColor(pacingData.currentPacing)}`}>
                            <span className="font-bold flex items-center">
                                ...
                                <span className="ml-2 capitalize">
                                    {pacingData.currentPacing.replace('_', ' ')}
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="mt-4">
                        <div className="flex justify-between text-sm text-gray-600 mb-1">
                            <span>Progress</span>
                            <span>{completedCount} of {atoms.length} completed</span>
                        </div>
                ...
                {currentPhase === 'complete' && (
                    <AtomComplete
                        ...
                        metrics={{
                            averageMastery: atoms.reduce((acc, a) => acc + (a.mastery_score || 0), 0) / atoms.length,
                            completedCount,
